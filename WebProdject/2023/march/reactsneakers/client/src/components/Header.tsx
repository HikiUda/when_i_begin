            ...
            <div className="header__row">
               <div className="header__logo-block">
                  ...
                  <div className="header__titles">
                     <h2 className="header__big-title">REACT SNEAKERS</h2>
                     <h3 className="header__min-title">Магазин лучших кроссовок</h3>
                  </div>
               </div>
               <div className="header__action-block">
                  ...
                  <Link to="/liked" className="header__liked-btn">
                     <svg
                        width="22"
                        height="19"
                        viewBox="0 0 22 19"
                  ...
                  <Link to="/purches" className="header__person-btn">
                     <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
