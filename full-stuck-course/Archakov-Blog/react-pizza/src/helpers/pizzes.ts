...
export type ListSortBy = { name: string; sortValue: string };

const listSortBy: ListSortBy[] = [
   { name: 'популярности asc', sortValue: 'rating' },
   { name: 'популярности desc', sortValue: '-rating' },
   { name: 'цене asc', sortValue: 'price' },
   { name: 'цене desc', sortValue: '-price' },
   { name: 'алфавиту asc', sortValue: 'title' },
   { name: 'алфавиту desc', sortValue: '-title' },
];

export { categories, listSortBy };
